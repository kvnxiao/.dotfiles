...
`neroued/Qwen3.8-27B-nvfp4-NInfer`. Its command sets a 128K context, FP8 KV cache, MTP speculation
with three draft tokens, and 4096 MiB of host KV storage.
...
`8080` and publishes host port `8001`. Its API model name is `qwen3.8-27b-ninfer`.
