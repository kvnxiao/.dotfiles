...
If no entry is active, use `lmserve start qwen3.8-27b-ninfer`. NInfer listens on
container port `8080` and publishes host port `8001`. It exposes
`qwen3.8-27b` as its API model name.
